  ...
  Future<void> _submit() async {
    ...
    required String receiptPath, // 🖼️ مسار الصورة
      ...
      await _apiService.makeDeposit(
        ...
        note: 'Recharge via ${rechargeData.paymentData.name}',
        receiptPath: rechargeData.image.path,
        paymentMethodId: rechargeData.paymentData.id,
      );
                          ...
                          IconButton(
                            onPressed: () {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                      LocaleKeys.copied_account_number.tr()),
