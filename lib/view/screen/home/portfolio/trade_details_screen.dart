    ...
    return Scaffold(
      ...
      body: BlocBuilder<LivePriceCubit, LivePriceState>(
        ...
        final double livePrice =
            (mp?.buy ?? 0).toDouble() * trade.unitGramWeight!;
                                          ...
                                          children: [
                                            ...
                                            BlocBuilder<ProductCubit,
                                              ...
                                              builder: (context, state) {
                                                var cubit =
                                                    ProductCubit.get(context);
                                                cubit.takeProfit=trade.takeProfit==null?false:true;
                                                cubit.takeProfitController.text= Methods.removeTrailingZeros(trade.takeProfit??0);
                                                return Switch.adaptive(
