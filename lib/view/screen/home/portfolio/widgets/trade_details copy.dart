...
//<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
/// اللنسخه قبل  معدل التاب بار
///
// class TradeDetailsScreen extends StatelessWidget {
//   final TradeOrOrder trade;
//   final String productTitle;
//   TradeDetailsScreen(
//       {super.key, required this.trade, required this.productTitle});
//
...
//                       child: Text(
//                         "$productTitle ${trade.unitGramWeight} gm",
...
//                           //
//                           //
//                           //     : LocaleKeys.lose.tr().toUpperCase(),
//                           'P&L',
//                           style: Theme.of(context).textTheme.titleMedium?.copyWith(
//                             color: AppColors.yellow,
//                           ),
...
//
//                         // Text(
//                         //   Methods.removeTrailingZeros(pnl)
//                         //   style: Theme.of(context).textTheme.titleMedium?.copyWith(
//                         //         color: AppColors.blueColor,
//                         //       ),
//                         // ),
...
//
// ///////////////////////////////////////////////////////////////////////////////////////////////////////// take profit
//                     trade.takeProfit==null||  trade.takeProfit==0?const SizedBox():
//                     Row(
//                       children: [
//                         Text(
//                           "take profit",
...
//                         const Spacer(),
//                         Text(
//                           Methods.removeTrailingZeros(  trade.takeProfit!),
//
//                           style: Theme.of(context).textTheme.titleMedium?.copyWith(
//                             color: AppColors.white,
//                           ),
...
//                       ],
//                     ),
//                     trade.stopLoss==null||  trade.stopLoss==0?const SizedBox():
//                     Divider(
//                       height: 20.h,
//                       color: AppColors.greyText,
//                     ),
...
//                         const Spacer(),
//                         Text(
//                           Methods.removeTrailingZeros(  trade.quantity!*livePrice),
//                           style: Theme.of(context).textTheme.titleMedium?.copyWith(
//                             color: AppColors.white,
//                           ),
//                         ),
...
//                               child: TabBarView(
//                                 children: [
//                                   // ✅ TAB 1 (Edit) => Scroll عشان ميفيضش لتحت
...
//                                                       // cubit.stopLoss=trade.stopLoss==null?false:true;
//                                                       // cubit.stopLossController.text= Methods.removeTrailingZeros(trade.stopLoss??0);
//                                                       //
//                                                       //
//
//
...
//                                                         .text),
//                                                     ctx: context);
//                                                 AppLoader.closeLoader(context,
//                                                     const ValueKey("updateOrder"));
//                                                 Navigation.push(
//                                                   context,
//                                                   LayoutScreen(),
//                                                 );
...
//                                           child: ElevatedButton(
//                                             onPressed: () async {
//                                               final deliveryData = await showDialog<
//                                                   Map<String, String>>(
//                                                 context: context,
//                                                 builder: (context) =>
...
//                                                 print(
//                                                     'Delivery City: ${deliveryData['delivery_city']}');
//                                                 print(
//                                                     'Delivery Phone: ${deliveryData['delivery_phone']}');
//
//                                                 AppLoader.showLoader(context,
//                                                     ValueKey("requestDelivery"));
//                                                 _appService.requestDelivery(
//                                                     orderId: trade.id ?? 0,
//                                                     deliveryAddress: deliveryData[
//                                                     "delivery_address"] ??
//                                                         '',
//                                                     deliveryCity: deliveryData[
//                                                     "delivery_city"] ??
//                                                         '',
//                                                     deliveryPhone: deliveryData[
//                                                     "delivery_phone"] ??
//                                                         '',
//                                                     ctx: context);
//                                               }
