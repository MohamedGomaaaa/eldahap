...
///////////////////////////////////////////////////////////////////////////////////////////////// quantityController
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: Text(
                                        LocaleKeys.sellWhenPriceIs, // (زي ما انت كاتبها)
                                        style: Theme.of(context)
                                            .textTheme
                                            .bodyLarge
                                            ?.copyWith(
...
///////////////////////////////////////////////////////////////////////////////////////////////// amount  that will change order to open trade
                                          ...
                                          BlocBuilder<ProductCubit, ProductState>(
                                            ...
                                            builder: (context, state) {
                                              return TextFormField(
                                                controller: cubit.sellWhenController,
                                                textInputAction: TextInputAction.done,
                                                style: Theme.of(context)
                                                    .textTheme
                                                    .headlineMedium
                                                ...
                                                // ✅ هنا بقى live
                                                validator: (value) =>
                                                    Validator.validatePriceWithRange(
                                                      value: value,
                                                      originalPrice: liveOpenPrice,
                                                    ),
                                ...
                                const Divider(color: AppColors.yellowBorder),
                                SizedBox(height: 12.h),
